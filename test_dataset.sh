...
export PGM=dataset.py    # <--- CHANGE THIS
export SLURM_SUBMIT_DIR=/fs/scratch/PAS2400/ASR_groupofdeskclosesttothedoor/final_project/Intelligibility-Oriented-Audio-Visual-Speech-Enhancement # <--- CHANGE THIS, everything else stay the same
